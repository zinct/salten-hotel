                ...
                <div class="col-lg-6">
                  ...
                  <div class="p-4">
                    ...
                    <div class="text-center">
                      <h1 class="h4 text-gray-900 mb-4">Selamat Datang Di Salten Hotel Luxury Bandung</h1>
                    </div>
                    <form class="user" action="" method="post">
                      ...
                      <div class="form-group">
                        <input type="password" name="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password" value="<?= set_value('password'); ?>">
